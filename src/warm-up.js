...
var sequel = title + " and the Chamber";
var sequel = `${title} and the Chamber`;
...
if (pages < 1000) {
  statement = "I could read that in a day!"
}
else {
  statement = "Ok, maybe I could read that in a day and a half"
}
...
if (isFavorite) {
  statement2 = `My favorite book is ${title}`
}
else {
  statement2 = `I recently read the ${title} book`
}
...
// variable indices "index" = [0, 1, 2, 3, 4]

assert.equal(title, "Harry Potter")
...
var belowTwoHundred = [123, 6, 24, 156, 78, 99, 102, 9, 101, 16, 43, 4];
